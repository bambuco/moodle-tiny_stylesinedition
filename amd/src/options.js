...
/**
 * Options helper for stylesinedition plugin
 *
 * @module     tiny_stylesinedition/options
 * @copyright  2026 David Herney @ BambuCo
 * @license    http://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
 */

import {getPluginOptionName} from 'editor_tiny/options';
import {pluginName} from 'tiny_stylesinedition/common';

const contextIdName = getPluginOptionName(pluginName, 'contextid');

/**
 * Register the options for the stylesinedition plugin.
 *
